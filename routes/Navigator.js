...
import Despedida from "../Screens/Despedida";
    ...
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen
          ...
          options={({ navigation }) => ({
            headerTitle: () => (
              <Nav title="Resto Book" navigation={navigation} />
            ),
          })}
        />
        <Stack.Screen name="RegisterUser" component={AddUserScreen} />
        <Stack.Screen name="RegisterResto" component={RegisterResto} />
        <Stack.Screen name="MenuResto" component={AddMenuRestoScreen} />
        <Stack.Screen name="DetailsResto" component={DetailsResto} />
        ...
        <Stack.Screen name="Despedida" component={Despedida} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
